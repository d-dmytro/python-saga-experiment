...
class Booking:
    def __init__(
        self, id: str, order_id: str, payment_id: str, status: str, color: str
    ) -> None:
        self.id = id
...
def create_payment_created_handler(
    publisher: Publisher, bookings: dict[str, Booking], ev_should_fail: Event
):
    def payment_created_handler(body: bytes, _):
        # create booking
...
def main():
    ...
    payment_created_handler = create_payment_created_handler(
